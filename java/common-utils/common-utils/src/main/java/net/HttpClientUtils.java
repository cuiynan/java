...
public class HttpClientUtils {
    ...
    public static void main(String[] args) throws ConnectTimeoutException, SocketTimeoutException, Exception{
        String url = "http://58.87.91.65:9104/ocr/process_txt";
        String httpRes = null;
        String localFileName = "C:\\Users\\gaowei\\Desktop\\s.png";
        File file=new File(localFileName);
        Map<String,ContentBody> reqParam = new HashMap<String,ContentBody>();
        reqParam.put("images", new FileBody(file));
//        String fileType=".png";
//        reqParam.put("images", new StringBody(localFileName, ContentType.MULTIPART_FORM_DATA));
//        reqParam.put("file", new StringBody(fileType, ContentType.MULTIPART_FORM_DATA));
        httpRes = postFileMultiPart(url,reqParam);
        System.out.println(httpRes);

    }
    public static final int connTimeout=10000000;
    public static final int readTimeout=10000000;
    ...
    static {
        ...
        HttpRequestRetryHandler retryHandler = new HttpRequestRetryHandler() {
            ...
            public boolean retryRequest(
                ...
                if (idempotent) {
                    // Retry if the thirdinterface is considered idempotent
                    return true;
                }
                return false;
            }
        ...
        client = HttpClients.custom().setRetryHandler(retryHandler).setConnectionManager(cm).build();
    }
