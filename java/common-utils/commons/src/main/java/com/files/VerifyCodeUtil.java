...
public class VerifyCodeUtil {
    ...
    public static final String VERIFY_CODES = "23456cdefghjkmnQAZWSXEp123456789qrstuvw23456xyzDCRFVT34567abGBY123456789HNUJMKL";
     ...
     * @return
     */
    public static String getIntegerCode(int verifySize){
    	String aa="0123456789";
        return generateVerifyCode(verifySize, aa);
    }
    /**
     * 使用系统默认字符源生成验证码
     * @param verifySize    验证码长度
    ...
    public static BufferedImage getImage(int w,int h,String code){
        ...
        for(int i = 0; i < verifySize; i++){
            ...
            g2.drawChars(chars, i, 1, ((w-10) / verifySize) * i + 2, h/2 + fontSize/2 - 5);
        }
